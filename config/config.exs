...
config :api_app, ApiApp.Guardian,
      issuer: "api_app",
      secret_key: %{"k" => "FshdJeCO4mBe6pqFXnnpnQ", "kty" => "oct"}


config :api_app, ApiApp.Repo, migration_primary_key: [type: :uuid]


config :api_app,
   uploads_directory: "/file_uploads"
...
config :api_app, ApiAppWeb.Endpoint,
  ...
  live_view: [signing_salt: "cAG08gj3"]
